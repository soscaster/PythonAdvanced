...
class Main:
    ...
    def __init__(self):
        ...
        if os.path.exists("students.dat"):
            clear()
            print("Detected students.dat file!")
            print("-----------------")
    ...
    def compress_txt_files(self):

        # Compress all files txt into students.dat
        print("Compressing txt files to students.dat ...")
        with open("students.dat", "wb") as outfile:
        ...
        # Delete the previous students.txt file
        print("Deleting previous txt files...")
        if os.path.exists("students.txt"):
            os.remove("students.txt")
        # Delete the previous courses.txt file
        if os.path.exists("courses.txt"):
            os.remove("courses.txt")
        # Delete the previous marks.txt file
